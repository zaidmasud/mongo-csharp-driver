    ...
    public class BsonClassMapSerializer : IBsonSerializer, IBsonIdProvider, IBsonDocumentSerializer
    {
                ...
                if (actualType != nominalType || _classMap.DiscriminatorIsRequired || _classMap.HasRootClass)
                {
                    ...
                    if (!_classMap.IsAnonymous)
                    {
                        ...
                        if (discriminator != null)
                        {
                            ...
                            SerializerRegistry.BsonValueSerializer.Serialize(bsonWriter, typeof(BsonValue), discriminator, null);
                        }
                    }
                }
            ...
            BsonMemberMap extraElementsMemberMap)
        {
            if (extraElementsMemberMap.MemberType == typeof(BsonDocument))
            {
                ...
                var bsonValue = (BsonValue)SerializerRegistry.BsonValueSerializer.Deserialize(bsonReader, typeof(BsonValue), null);
            ...
            if (extraElements != null)
            {
                if (extraElementsMemberMap.MemberType == typeof(BsonDocument))
                {
                    ...
                    foreach (var element in bsonDocument)
                    {
                        ...
                        SerializerRegistry.BsonValueSerializer.Serialize(bsonWriter, typeof(BsonValue), element.Value, null);
                    }
                }
                else
                {
                    ...
                    foreach (var key in dictionary.Keys)
                    {
                        ...
                        else
                        {
                            ...
                            SerializerRegistry.BsonValueSerializer.Serialize(bsonWriter, typeof(BsonValue), bsonValue, null);
                        }
                    }
                }
            }
