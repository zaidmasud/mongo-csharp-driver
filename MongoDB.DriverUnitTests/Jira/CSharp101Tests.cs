...
namespace MongoDB.DriverUnitTests.Jira.CSharp101
{
    ...
    public class CSharp101Tests
    {
        ...
        {
            var collection = Configuration.GetTestCollection<CNoId>();
            collection.RemoveAll();
        ...
        {
            var collection = Configuration.GetTestCollection<CObjectId>();
            collection.RemoveAll();
        ...
        {
            var collection = Configuration.GetTestCollection<CGuid>();
            collection.RemoveAll();
        ...
        {
            var collection = Configuration.GetTestCollection<CInt32Id>();
            collection.RemoveAll();
        ...
        {
            var collection = Configuration.GetTestCollection<CInt64Id>();
            collection.RemoveAll();
        ...
        {
            var collection = Configuration.GetTestCollection<CStringId>();
            collection.RemoveAll();
