    ...
    public class SelectQueryTests
    {
        ...
        public void Setup()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                collection.Drop();
                collection.Insert(new C { Id = _id2, X = 2, LX = 2, Y = 11, D = new D { Z = 22 }, A = new[] { 2, 3, 4 }, DA = new List<D> { new D { Z = 111 }, new D { Z = 222 } }, L = new List<int> { 2, 3, 4 } });
                collection.Insert(new C { Id = _id1, X = 1, LX = 1, Y = 11, D = new D { Z = 11 }, S = "abc", SA = new string[] { "Tom", "Dick", "Harry" } });
                collection.Insert(new C { Id = _id3, X = 3, LX = 3, Y = 33, D = new D { Z = 33 }, B = true, BA = new bool[] { true }, E = E.A, EA = new E[] { E.A, E.B } });
                collection.Insert(new C { Id = _id5, X = 5, LX = 5, Y = 44, D = new D { Z = 55 }, DBRef = new MongoDBRef("db", "c", 1) });
                collection.Insert(new C { Id = _id4, X = 4, LX = 4, Y = 44, D = new D { Z = 44 }, S = "   xyz   ", DA = new List<D> { new D { Z = 333 }, new D { Z = 444 } } });
            }
        }
        ...
        public void TestAggregate()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = (from c in collection.AsQueryable<C>()
        ...
        public void TestAnyWithPredicateAfterProjection()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = collection.AsQueryable<C>().Select(c => c.Y).Any(y => y == 11);
            }
        }
        ...
        public void TestAnyWithPredicateAfterWhere()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = collection.AsQueryable<C>().Where(c => c.X == 1).Any(c => c.Y == 11);
                Assert.IsTrue(result);
            }
        }
        ...
        public void TestAnyWithPredicateFalse()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = collection.AsQueryable<C>().Any(c => c.X == 9);
                Assert.IsFalse(result);
            }
        }
        ...
        public void TestAnyWithPredicateTrue()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = collection.AsQueryable<C>().Any(c => c.X == 1);
                Assert.IsTrue(result);
            }
        }
        ...
        public void TestAsQueryableWithNothingElse()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = collection.AsQueryable<C>();
        ...
        public void TestCountWithPredicate()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = collection.AsQueryable<C>().Count(c => c.Y == 11);
        ...
        public void TestCountWithPredicateAfterProjection()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = collection.AsQueryable<C>().Select(c => c.Y).Count(y => y == 11);
            }
        }
        ...
        public void TestCountWithPredicateAfterWhere()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = collection.AsQueryable<C>().Where(c => c.X == 1).Count(c => c.Y == 11);
        ...
        public void TestDistinctWithEqualityComparer()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = collection.AsQueryable<C>().Distinct(new CEqualityComparer());
                query.ToList(); // execute query
            }
        }
        ...
        public void TestFirstOrDefaultWithPredicateAfterProjection()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = collection.AsQueryable<C>().Select(c => c.Y).FirstOrDefault(y => y == 11);
            }
        }
        ...
        public void TestFirstWithPredicateAfterProjection()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = collection.AsQueryable<C>().Select(c => c.Y).First(y => y == 11);
            }
        }
        ...
        public void TestGroupJoin()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var inner = new C[0];
                var query = collection.AsQueryable<C>().GroupJoin(inner, c => c, c => c, (c, e) => c);
                query.ToList(); // execute query
            }
        }
        ...
        public void TestGroupJoinWithEqualityComparer()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var inner = new C[0];
                var query = collection.AsQueryable<C>().GroupJoin(inner, c => c, c => c, (c, e) => c, new CEqualityComparer());
                query.ToList(); // execute query
            }
        }
        ...
        public void TestJoin()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = collection.AsQueryable<C>().Join(collection.AsQueryable<C>(), c => c.X, c => c.X, (x, y) => x);
                query.ToList(); // execute query
            }
        }
        ...
        public void TestJoinWithEqualityComparer()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = collection.AsQueryable<C>().Join(collection.AsQueryable<C>(), c => c.X, c => c.X, (x, y) => x, new Int32EqualityComparer());
                query.ToList(); // execute query
            }
        }
        ...
        public void TestLastOrDefaultWithPredicateAfterProjection()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = collection.AsQueryable<C>().Select(c => c.Y).LastOrDefault(y => y == 11);
            }
        }
        ...
        public void TestLastWithPredicateAfterProjection()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = collection.AsQueryable<C>().Select(c => c.Y).Last(y => y == 11);
            }
        }
        ...
        public void TestSelectMany()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = collection.AsQueryable<C>().SelectMany(c => new C[] { c });
                query.ToList(); // execute query
            }
        }
        ...
        public void TestSelectManyWithIndex()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = collection.AsQueryable<C>().SelectMany((c, index) => new C[] { c });
                query.ToList(); // execute query
            }
        }
        ...
        public void TestSelectManyWithIntermediateResults()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = collection.AsQueryable<C>().SelectMany(c => new C[] { c }, (c, i) => i);
                query.ToList(); // execute query
            }
        }
        ...
        public void TestSelectManyWithIndexAndIntermediateResults()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = collection.AsQueryable<C>().SelectMany((c, index) => new C[] { c }, (c, i) => i);
                query.ToList(); // execute query
            }
        }
        ...
        public void TestSelectWithIndex()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = collection.AsQueryable<C>().Select((c, index) => c);
                query.ToList(); // execute query
            }
        }
        ...
        public void TestSelectWithNothingElse()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = from c in collection.AsQueryable<C>() select c;
                var result = query.ToList();
                Assert.AreEqual(5, result.Count);
            }
        }
        ...
        public void TestSingleOrDefaultWithPredicateAfterProjection()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = collection.AsQueryable<C>().Select(c => c.Y).SingleOrDefault(y => y == 11);
            }
        }
        ...
        public void TestSingleWithPredicateAfterProjection()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var result = collection.AsQueryable<C>().Select(c => c.Y).Single(y => y == 11);
            }
        }
        ...
        public void TestSkipWhile()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = collection.AsQueryable<C>().SkipWhile(c => true);
                query.ToList(); // execute query
            }
        }
        ...
        public void TestTakeWhile()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = collection.AsQueryable<C>().TakeWhile(c => true);
                query.ToList(); // execute query
            }
        }
        ...
        public void TestThenByWithMissingOrderBy()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = ((IOrderedQueryable<C>)collection.AsQueryable<C>())
                    .ThenBy(c => c.X);
        ...
        public void TestWhereSIndexOfAnyBC()
        {
            ...
            {
                var database = session.GetDatabase(Configuration.TestDatabaseName);
                var tempCollection = database.GetCollection("temp");
                tempCollection.Drop();
        ...
        public void TestWhereSystemProfileInfoDurationGreatherThan10Seconds()
        {
            ...
            {
                var database = session.GetDatabase(Configuration.TestDatabaseName);
                var systemProfileCollection = database.GetCollection<SystemProfileInfo>("system.profile");

                var query = from pi in systemProfileCollection.AsQueryable<SystemProfileInfo>()
                            where pi.Duration > TimeSpan.FromSeconds(10)
                            select pi;

                var translatedQuery = MongoQueryTranslator.Translate(query);
                Assert.IsInstanceOf<SelectQuery>(translatedQuery);
                Assert.AreSame(systemProfileCollection, translatedQuery.Collection);
        ...
        public void TestWhereWithIndex()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = collection.AsQueryable<C>().Where((c, i) => true);
                query.ToList(); // execute query
            }
        }
        ...
        public void TestWhereXEquals1AndYEquals11UsingTwoWhereClauses()
        {
            using (var session = Configuration.TestServer.GetSession())
            {
                ...
                var query = collection.AsQueryable<C>().Where(c => c.X == 1).Where(d => d.Y == 11);
