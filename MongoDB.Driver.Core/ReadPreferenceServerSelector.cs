...
namespace MongoDB.Driver.Core
{
    ...
    public class ReadPreferenceServerSelector : ConnectedServerSelector
    {
        ...
        protected override IEnumerable<ServerDescription> SelectServerFromConnectedServers(IEnumerable<ServerDescription> servers)
        {
            ...
            switch(_readPreference.ReadPreferenceMode)
            {
                ...
                case ReadPreferenceMode.PrimaryPreferred:
                    ...
                    if (!selected.Any())
                    {
                        selected = Filter(servers.Where(n => n.Type == ServerType.ReplicaSetSecondary));
                    }
                    break;
                ...
                case ReadPreferenceMode.Nearest:
                    selected = Filter(servers.Where(n => n.Type.CanWrite() || n.Type == ServerType.ReplicaSetSecondary));
                    break;
                default:
        ...
        private IEnumerable<ServerDescription> Filter(IEnumerable<ServerDescription> servers)
        {
