...
{
    /// <summary>
    /// Args for ISession.CreateServerChannelProvider.
    /// </summary>
    public class CreateServerChannelProviderArgs
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to dispose of the session when the IServerChannelProvider is disposed.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether to create an IServerChannelProvider for a query.
        /// </summary>
        public bool IsQuery
        {
            get { return _isQuery; }
