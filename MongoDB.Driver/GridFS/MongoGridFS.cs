...
namespace MongoDB.Driver.GridFS
{
    ...
    public class MongoGridFS
    {
        ...
        {
            get { return _database.GetCollection<BsonDocument>(_settings.Root + ".files"); }
        }
        ...
        public void Download(Stream stream, MongoGridFSFileInfo fileInfo)
        {
            ...
            using (var connectionBinding = _database.Binding.NarrowToConnection(new ReadPreferenceNodeSelector(_database.Settings.ReadPreference)))
            {
