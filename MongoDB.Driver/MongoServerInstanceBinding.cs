...
namespace MongoDB.Driver
{
    ...
    /// </summary>
    public class MongoServerInstanceBinding : IMongoBinding
    {
        // private fields
        ...
        // constructors
        public MongoServerInstanceBinding(MongoServerInstance serverInstance)
        {
        ...
        {
            var internalConnection = _server.AcquireConnection(database, _serverInstance);
