...
namespace MongoDB.Driver
{
    internal class MongoReplyMessage<TDocument> : MongoMessage
    {
        ...
        internal MongoReplyMessage(SerializationConfig serializationConfig, BsonBinaryReaderSettings readerSettings)
            : base(serializationConfig, MessageOpcode.Reply)
        {
        ...
        internal void ReadFrom(BsonBuffer buffer, IBsonSerializationOptions serializationOptions)
        {
            ...
            using (BsonReader bsonReader = BsonReader.Create(buffer, _readerSettings))
            {
                ...
                {
                    var document = (BsonDocument)SerializationConfig.LookupSerializer(typeof(BsonDocument)).Deserialize(bsonReader, typeof(BsonDocument), null);
