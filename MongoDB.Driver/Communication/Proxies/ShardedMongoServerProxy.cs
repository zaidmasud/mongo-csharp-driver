...
namespace MongoDB.Driver.Internal
{
    ...
    internal sealed class ShardedMongoServerProxy : MultipleInstanceMongoServerProxy
    {
        ...
        public ShardedMongoServerProxy(MongoServerSettings settings, IEnumerable<MongoServerInstanceInternal> instances, BlockingQueue<MongoServerInstanceInternal> stateChangedQueue, int connectionAttempt)
