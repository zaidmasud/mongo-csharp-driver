    ...
    public class MongoCursorEnumerator<TDocument> : IEnumerator<TDocument>
    {
        ...
        private MongoConnection AcquireConnection()
        {
            if (_serverInstance == null)
            {
                ...
                var connection = _cursor.Server.AcquireConnection(_cursor.Database.Settings.Credentials, _readPreference);
            ...
            else
            {
                ...
                return _cursor.Server.AcquireConnection(_cursor.Database.Settings.Credentials, _serverInstance);
            }
        }
        ...
        private void KillCursor()
        {
            if (_openCursorId != 0)
            {
                try
                {
                    ...
                    {
                        var connection = _cursor.Server.AcquireConnection(_cursor.Database.Settings.Credentials, _serverInstance);
                        try
                        {
