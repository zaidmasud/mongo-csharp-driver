...
namespace MongoDB.Driver
{
    ...
    public class SystemProfileInfoSerializer : BsonDocumentBackedClassSerializer<SystemProfileInfo>
    {
        ...
        public SystemProfileInfoSerializer()
        {
            ...
            RegisterMember("Command", "command", CachedSerializers.BsonDocumentSerializer, typeof(BsonDocument), null);
            ...
            RegisterMember("Query", "query", CachedSerializers.BsonDocumentSerializer, typeof(BsonDocument), null);
            ...
            RegisterMember("UpdateObject", "updateobj", CachedSerializers.BsonDocumentSerializer, typeof(BsonDocument), null);
