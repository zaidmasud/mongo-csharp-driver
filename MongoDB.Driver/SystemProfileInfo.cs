...
namespace MongoDB.Driver
{
    ...
    public class SystemProfileInfoSerializer : BsonDocumentBackedClassSerializer<SystemProfileInfo>
    {
        ...
        public SystemProfileInfoSerializer()
        {
            ...
            RegisterMember("Command", "command", SerializerRegistry.BsonDocumentSerializer, typeof(BsonDocument), null);
            ...
            RegisterMember("Query", "query", SerializerRegistry.BsonDocumentSerializer, typeof(BsonDocument), null);
            ...
            RegisterMember("UpdateObject", "updateobj", SerializerRegistry.BsonDocumentSerializer, typeof(BsonDocument), null);
